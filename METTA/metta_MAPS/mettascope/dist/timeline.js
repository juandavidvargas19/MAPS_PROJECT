...
export function onScrubberChange(event) {
...
onEvent('mousedown', '#timeline-panel', (target, event) => {
...
/** Draws the timeline. */
export function drawTimeline(panel) {
    ...
    ctx.drawSolidRect(16, 34, scrubberWidth, 16, [0.5, 0.5, 0.5, 0.5] // White with 50% opacity
    );
