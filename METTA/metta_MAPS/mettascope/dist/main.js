...
onEvent('mousemove', 'body', (target, e) => {
    let event = e;
...
onEvent('mousedown', '.draggable', (target, e) => {
    let event = e;
    ui.dragHtml = target;
...
export function updateStep(newStep, skipScrubberUpdate = false) {
...
export function updateSelection(object, setFollow = false) {
...
function toggleOpacity(button, show) {
    if (show) {
