...
export function getAttr(obj, attr, atStep = -1, defaultValue = 0) {
    if (atStep == -1) {
...
export async function fetchReplay(replayUrl) {
...
async function loadReplayText(url, replayData) {
...
async function loadReplayJson(url, replayData) {
...
export function loadReplayStep(replayStep) {
...
/** Get object config. */
export function getObjectConfig(object) {
...
export function sendAction(actionName, actionParam) {
    if (state.ws === null) {
